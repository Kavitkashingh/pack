...
const Footer = () => {
    ...
    return (
        <footer className='bg-[#F3F6Fa]'>
            <div className='w-[95%] grid grid-row-2 mx-auto border-b py-16 md-lg:pb-10 sm:pb-6 '>
                <div className='sm:w-full flex  mb-3 pb-5 place-content-between '>
                    ...
                    <div className=''>
                        <button className='border border-black sm:hidden  px-[50px] py-2 rounded-full hover:border-none font-bold hover:bg-red-500 hover:text-white' >Contact Us</button>
                    </div>
                </div>
                <hr />
                <div className='grid grid-cols-5 sm:grid-cols-2 sm-md:grid-col-2 md:grid-cols-3 sm:justify-center md:justify-center mt-8 place-content-between'>
                    ...
                    <div className='lg:w-full lg:mt-6 sm:ml-10 sm:justify-center '>
                        <div className='w-full flex flex-col sm:justify-center gap-3'>
            ...
            <div className='w-[90%] ml-24 pb-10 flex flex-wrap sm:flex-row  text-slate-600 place-content-between pt-5'>
                <span>Copiright ©2023 All rights reserved</span>
                <div>
                    <ul className='flex space-x-4 sm:flex-col  text-lg'>
                        <li>
