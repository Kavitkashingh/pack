                ...
                <div className='w-[95%] lg:w-[90%] mx-auto'>
                    <div className='h-[90px] md-lg:h-[100px] flex justify-between items-center flex-wrap  md:flex-nowrap'>
                        <div className='md-lg:w-full md-lg:pt-4'>
                            <div className='flex justify-between items-center w-full md:w-auto'>
                                <Link to='/'>
                                    <img src="http://localhost:3000/images/logo.png" alt="logo" className="h-10 md:h-12" />
                                </Link>
                        ...
                        <div className='w-lg md:hidden'>
                            <div className='flex justify-between md-lg:justify-center items-center sm:hidden flex-wrap'>
                                <div className='flex justify-start items-start gap-2 text-sm font-bold uppercase md-lg:hidden' >
                                    <div className='flex border rounded-full h-[45px] items-center relative gap-2 justify-center my-2 md:my-0 md:justify-start'>
                                        <div className='relative after:absolute after:h-[20px] after:w-[1px] after:bg-[#afafaf] after:-right-[15px] md:hidden flex max-w-xs md:max-w-md lg:max-w-lg'>
                                            <select onChange={(e) => setCategory(e.target.value)} className='w-[130px] text-black font-medium bg-transparent px-3 h-full outline-0 border-none ' name="" id="">
                                        ...
                                        <input className='w-[200px] px-3 relative bg-transparent text-slate-500 outline-0 h-full' onChange={(e) => setSearchValue(e.target.value)} type="text" name="" id="" />
                                ...
                                <div className='flex md-lg:hidden w-[600px] justify-center items-center'>
                                    <div className=' relative'>
                                        <div onMouseEnter={() => setCategoryShow(!categoryShow)} className='flex rounded-lg cursor-pointer hover:bg-slate-200 py-2 justify-center items-center gap-2 text-sm w-[200px]'>
                                            <div className="flex gap-2 text-lg text">
                                                <span>
                                                    {
                                    ...
                                    <div className='flex justify-end items-center gap-4'>
                                        ...
                                        <Link className='flex cursor-pointer justify-center items-center gap-2 rounded-lg hover:bg-slate-200 py-2 px-3 w-40 ' to='/bulk'>
                                        ...
                                        <Link className='flex cursor-pointer justify-center items-center gap-2 rounded-lg w-48  hover:bg-slate-200 py-2 ' to='/becomeseller'>
                    ...
                    <div className='hidden md-lg:block'>
                        ...
                        <div className={`w-[300px] z-[9999] transition-all duration-200 fixed  ${showShidebar ? '-left-[300px]' : 'left-0'} top-0 overflow-y-auto bg-white h-screen py-6 px-8`}>
                            ...
                            <div className='flex items-start gap-2 text-sm font-bold uppercase py-6 justify-center'>
                                <div className='flex border rounded-full h-[45px] items-center relative gap-2 justify-center my-2 md:my-0 md:justify-start'>
                                    <div className='relative after:absolute after:h-[20px] after:w-[1px] after:bg-[#afafaf] after:-right-[15px] md:hidden flex max-w-xs md:max-w-md lg:max-w-lg'>
                                        <select onChange={(e) => setCategory(e.target.value)} className='w-[130px] text-black font-medium bg-transparent px-3 h-full outline-0 border-none ' name="" id="">
                                            <option value="">Search here</option>
                            ...
                            <div className='w-[250px] justify-center items-center'>
                                    <div className=' relative'>
                                        <div onMouseEnter={() => setCategoryShow(!categoryShow)} className='flex rounded-lg cursor-pointer hover:bg-slate-200 py-2 justify-center items-center gap-2 text-sm w-[200px]'>
                                            <div className="flex gap-2 text-lg text">
                                                <span>
                                    ...
                                    <div className=' justify-center items-center gap-4'>
                                        ...
                                        <div onClick={redirect_card_page} className='relative flex justify-center ml-5 py-2 items-center cursor-pointer w-[35px] h-[35px] rounded-full bg-red-500'>
                                                <span className='text-xl text-white'><FaCartArrowDown /></span>
                                                {
                                                    card_product_count !== 0 && <div className='w-[40px] h-[40px] absolute bg-green-500 rounded-full text-white flex justify-center items-center -top-[3px] -right-[5px]'>
                                                        {
