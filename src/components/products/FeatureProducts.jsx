...
const FeatureProducts = ({ products }) => {
    ...
    return (
        ...
        <div className='w-[100%] flex flex-wrap justify-center items-center mx-auto overflow-hidden'>
            ...
            <div className='rounded-3xl grid grid-cols-4 sm:grid-cols-2 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 md-lg:grid-cols-3 gap-7 p-2'>
                {
                    products.map((p, i) => <div key={i} className='h-[540] w-[300px] group border p-2 bg-[#f2f2f2] rounded-3xl group transition-all duration-500 hover:shadow-md hover:-mt-3'>
                        ...
                        <div className='mt-[19px] text-black px-3 '>
                            ...
                            <div className='flex mt-3'>
                                ...
                                <div className='flex' >
                                    <li onClick={() => add_card(p._id)} className='w-[36px] mr-2 h-[36px]  cursor-pointer bg-white flex justify-center items-center rounded-full text-black transition-all'><AiOutlineShoppingCart /></li>

                                    <Link  onClick={handleOpen}   ><button className='w-[111px] h-[35px] cursor-pointer hover:shadow-lg hover:shadow-red-500/40 bg-red-500 font-bold rounded-full text-white'>Buy Now</button> </Link>
